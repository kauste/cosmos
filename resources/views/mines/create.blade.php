...
<div class="container">
    <div class="row p-1 p-sm-2 justify-content-center">
        ...
        <div class="col-xl-5 col-lg-6 col-md-9 col-sm-11 col-12 p-sm-5 p-0 pb-0 pl-3 pt-2 bg-main">
            <form method="post" action="{{route('mine-store')}}" class="m-0 mb-2 m-sm-2 row align-items-center">
                @if($cntr)
                ...
                <div class="col-12 mb-4 d-flex gap-1 justify-content-start align-items-center">
                    ...
                    <div class="col-4 col-sm-5 d-flex justify-content-center">
                        <div class="btn btn-outline-secondary p-1 add-button longitude--button d-none ">Show availible</div>
                        <div class="btn btn-outline-secondary p-1 add-button dont--longitude--button d-none ">Don't show</div>
                    </div>
                </div>
                ...
                <div class="col-12 mb-4 d-flex gap-1 justify-content-start align-items-center">
                    ...
                    <div class="col-4 col-sm-5 d-flex justify-content-center">
                        <div class="btn btn-outline-secondary add-button latitude--button d-none">Show availible</div>
                        <div class="btn btn-outline-secondary add-button dont--latitude--button d-none ">Don't show</div>
                    </div>
                </div>
