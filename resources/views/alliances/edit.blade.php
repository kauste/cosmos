...
<div class="container">
    <div class="row p-2 justify-content-center">
        ...
        <div class="col-xxl-5 col-lg-7 col-md-9 p-md-5 p-2 pb-0 pl-3 pt-2 bg-main">
            <form method="post" action="{{route('alliance-update')}}" class="m-2 row align-items-center">
                ...
                <div class="col-12 mt-3 d-flex  gap-3 justify-content-center">
                    <button type="submit" class="btn btn-outline-secondary update-button mb-3">Edit alliance</button>
